...
using DioMod.Modules.Characters;
using DioMod.Survivors.Henry.SkillStates;
using RoR2;
using RoR2.Skills;
using System;
...
{
    public class DioSurvivor : SurvivorBase<DioSurvivor>
    {
        //used to load the assetbundle for this character. must be unique
        public override string assetBundleName => "dioassetbundle"; //if you do not change this, you are giving permission to deprecate the mod

        //the name of the prefab we will create. conventionally ending in "Body". must be unique
        public override string bodyName => "HenryBody"; //if you do not change this, you get the point by now

        //name of the ai master for vengeance and goobo. must be unique
        public override string masterName => "DioMonsterMaster"; //if you do not

        //the names of the prefabs you set up in unity that we will use to build your character
        public override string modelPrefabName => "mdlHenry";
        public override string displayPrefabName => "HenryDisplay";

        public const string HENRY_PREFIX = DioPlugin.DEVELOPER_PREFIX + "_DIO_";
        ...
        public override UnlockableDef characterUnlockableDef => DioUnlockables.characterUnlockableDef;
        
        public override ItemDisplaysBase itemDisplays => new DioItemDisplays();
        ...
        public override void InitializeCharacter()
        {
            ...
            DioAssets.Init(assetBundle);
            DioBuffs.Init(assetBundle);
        ...
        {
            AddHitboxes();
            bodyPrefab.AddComponent<DioWeaponComponent>();
            bodyPrefab.AddComponent<StandLinkComponent>();
        ...
        private void AddSecondarySkills()
        {
            ...
            SkillDef secondarySkillDef1 = Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.KnifeThrow)),
        ...
        public override void InitializeCharacterMaster()
        {
            ...
            DioAI.Init(bodyPrefab, masterName);
        ...
        private void RecalculateStatsAPI_GetStatCoefficients(CharacterBody sender, R2API.RecalculateStatsAPI.StatHookEventArgs args)
        {
            ...
            if (sender.HasBuff(DioBuffs.armorBuff))
            {
                args.armorAdd += 300;
            }
        }
